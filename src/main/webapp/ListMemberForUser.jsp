										...
										<tbody>
											<c:forEach items="${listMember}" var="it">
												...
												<tr class="odd" role="row">
													...
													<a href="ListMemberbyId?memberId=${it.memberId }" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
													<a href="DeleteMemberController?memberId=${it.memberId }" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
