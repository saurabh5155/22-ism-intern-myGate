...
<div class="nav-header">
	<a href="index.html" class="brand-logo"> <svg class="logo-abbr"
			...
			xmlns="http://www.w3.org/2000/svg">
				...
				fill="white"></path>
				</svg> <svg class="brand-title" width="74" height="22" viewBox="0 0 74 22"
...
<div class="deznav">
	<div class="deznav-scroll mm-active ps ps--active-y">
		<div class="main-profile">
			<div class="image-bx">
				<img src="images/Untitled-1.jpg" alt=""> <a
					href="javascript:void(0);"><i class="fa fa-cog"
					aria-hidden="true"></i></a>
			</div>
			<h5 class="name">
				<span class="font-w400">Hello,</span> Marquez
			</h5>

		</div>
		<ul class="metismenu mm-show" id="menu">
			<li class="nav-label first">Main Menu</li>
			<li class="mm-active"><a class="has-arrow ai-icon"
				href="javascript:void()" aria-expanded="false"> <i
					class="flaticon-144-layout"></i> <span class="nav-text">Add
						House</span>
			</a>
		...
		<div class="ps__rail-y" style="top: 0px; height: 609px; right: 0px;">
			<div class="ps__thumb-y" tabindex="0"
				style="top: 0px; height: 308px;"></div>
		</div>
	</div>
</div>